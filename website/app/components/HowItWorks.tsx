  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 28 28" fill="none">
        ...
        <line x1="10" y1="14" x2="15" y2="14" stroke="rgba(255,255,255,0.5)" strokeWidth="1.4" strokeLinecap="round" />
      </svg>
    ),
    variant: 'up' as const,
  },
    ...
    <section id="how-it-works" className="py-32 px-6" style={{ background: '#080808' }}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Reveal variant="up" delay={420} className="mt-24">
          ...
          >
            <div className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-lg" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="10" stroke="rgba(255,255,255,0.4)" strokeWidth="1.6" />
