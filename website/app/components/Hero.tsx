...
export default function Hero() {
  return (
    <section
      ...
      style={{ background: 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(201,168,76,0.07) 0%, transparent 60%), #080808' }}
    >
      {/* Subtle grid */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="hero-icon mb-10">
          <svg width="72" height="72" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="48" cy="48" r="44" fill="rgba(201,168,76,0.05)" />
        ...
        <div className="hero-badge mb-8">
          <span className="text-xs font-medium tracking-[0.2em] uppercase px-4 py-1.5 rounded-full" style={{ border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.45)', background: 'rgba(255,255,255,0.03)' }}>
        ...
        {/* Subheading */}
        <p className="hero-sub text-xl sm:text-2xl font-light mb-5 tracking-tight" style={{ color: 'rgba(255,255,255,0.7)', letterSpacing: '-0.01em' }}>
          The research assistant that never leaves your office.
        </p>

        {/* Body */}
        <p className="hero-body text-base sm:text-lg leading-relaxed max-w-2xl mb-6" style={{ color: 'rgba(255,255,255,0.4)' }}>
        ...
        {/* Disclaimer */}
        <p className="hero-disclaimer text-sm italic mb-10 px-5 py-3 rounded-lg" style={{ color: 'rgba(255,255,255,0.3)', border: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.02)' }}>
        ...
        <div className="hero-ctas flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.background = '#dbb85e' }}
          ...
          <a
            ...
            onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(255,255,255,0.12)'; (e.currentTarget as HTMLAnchorElement).style.color = 'rgba(255,255,255,0.6)' }}
          >
            Learn How It Works
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M8 3l5 5-5 5M3 8h10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </a>
        </div>
