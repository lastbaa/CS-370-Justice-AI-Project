  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 60% 45% at 50% 0%, rgba(255,255,255,0.022) 0%, transparent 70%)' }}
      />
      {/* Bottom fade */}
      <div
      ...
      <div className="relative z-20 max-w-4xl mx-auto flex flex-col items-center">
        ...
        {/* Floating scales icon — only gold element on the page */}
        <div className="hero-icon mb-10">
          <svg width="62" height="62" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
