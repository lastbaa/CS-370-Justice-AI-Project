    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16 3L5 7.5v8c0 6.08 4.67 11.77 11 13 6.33-1.23 11-6.92 11-13v-8L16 3z"
          stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" strokeLinejoin="round" fill="none" />
        <rect x="11.5" y="14" width="9" height="7" rx="1.5" stroke="rgba(255,255,255,0.7)" strokeWidth="1.6" fill="none" />
        <path d="M13 14v-2.5a3 3 0 016 0V14" stroke="rgba(255,255,255,0.7)" strokeWidth="1.6" strokeLinecap="round" fill="none" />
        <circle cx="16" cy="17.5" r="1.2" fill="rgba(255,255,255,0.7)" />
        <rect x="15.4" y="17.5" width="1.2" height="2" rx="0.6" fill="rgba(255,255,255,0.7)" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="16" cy="16" r="12" stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" fill="none" />
        <path d="M10 16.5l4 4 8-8" stroke="rgba(255,255,255,0.7)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="16" cy="16" r="12" stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" fill="none" />
        <path d="M16 10v6l4 2" stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8 4h11l5 5v19H8V4z" stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" strokeLinejoin="round" fill="none" />
        <path d="M19 4v5h5" stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" strokeLinejoin="round" />
        <line x1="12" y1="20" x2="20" y2="20" stroke="rgba(255,255,255,0.7)" strokeWidth="1.4" strokeLinecap="round" />
        <line x1="12" y1="23" x2="17" y2="23" stroke="rgba(255,255,255,0.7)" strokeWidth="1.4" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16 4C9.37 4 4 9.37 4 16s5.37 12 12 12 12-5.37 12-12S22.63 4 16 4z"
          stroke="rgba(255,255,255,0.7)" strokeWidth="1.8" fill="none" />
        <path d="M16 4c0 6-4 10-4 10s4 2 4 8" stroke="rgba(255,255,255,0.7)" strokeWidth="1.6" strokeLinecap="round" fill="none" />
        <path d="M28 16c-6 0-10-4-10-4s-2 4-8 4" stroke="rgba(255,255,255,0.7)" strokeWidth="1.6" strokeLinecap="round" fill="none" />
      </svg>
    ),
  },
]
...
function FeatureCard({ feature }: { feature: typeof features[0] }) {
  return (
    <div
      className="relative h-full rounded-xl p-7 flex flex-col gap-5 transition-colors duration-300"
      style={{
        background: '#111111',
    ...
    >
      <div className="w-10 h-10 flex items-center justify-center rounded-lg" style={{ background: 'rgba(255,255,255,0.04)' }}>
        {feature.icon}
      </div>
      <div>
