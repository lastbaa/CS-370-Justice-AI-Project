...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[28rem] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
        className
      )}
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full opacity-40 blur-3xl" style={{ background: '#c9a84c' }} />
        <motion.div
          initial={{ width: "8rem" }}
