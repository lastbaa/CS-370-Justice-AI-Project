...
export default function SourceCard({ citation }: Props): JSX.Element {
  ...
  return (
    <div className="mt-2 rounded-lg border border-l-4 border-[#30363d] border-l-[#c9a84c] bg-[#161b22] px-4 py-3">
      <div className="flex items-start justify-between gap-3 mb-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-sm font-medium text-[#e6edf3] truncate" title={citation.fileName}>
            {citation.fileName}
          </span>
        </div>
        <div className="flex items-center gap-3 flex-shrink-0">
          <span className="text-xs text-[#8b949e]">
            Page <span className="font-medium text-[#e6edf3]">{citation.pageNumber}</span>
          </span>
          <div className="flex items-center gap-1">
            <div className="h-1.5 w-12 rounded-full bg-[#30363d] overflow-hidden">
              <div
